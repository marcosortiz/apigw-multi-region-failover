"""
Unit tests for External API Lambda function
"""
import json
import os
import pytest
...
class TestExternalApiLambda:
    """Test cases for External API Lambda handler"""
    ...
    def test_lambda_handler_service_name(self):
        ...
        assert body['service'] == 'external-api'
